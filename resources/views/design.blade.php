...
<?php if (str_contains($url, 'lp3')) {?>
    @component('components.nav.nav6')
    @endcomponent
...
<?php } ?>
    ...
    @component('components.intros.design.design')
    @endcomponent
...
@endcomponent
@component('components.portfolio.portfolio')
@endcomponent
   


@component('components.hero.herotelegram')
    @endcomponent
