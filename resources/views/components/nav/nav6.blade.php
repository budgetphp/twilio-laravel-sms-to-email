  ...
  <div class="container-fluid">
    <nav class="navbar site-navbar offcanvas-active navbar-expand-lg  px-0">
      ...
      <div class="navbar-collapse collapse" id="mobile-menu" >
        ...
        <img src="{{env('APP_CDN_URL')}}/assets/Robo.svg" alt="" class="" style="max-height:47px;width:auto;">
        <span class="mr-5 d-none d-sm-block">Would you like a free Quote?</span>

        <div class="header-btn ml-auto ml-lg-0 d-none d-sm-block">

          <a class="btn btn btn-primary header-btn-2 font-size-3 rounded-5" href="{{env('APP_URL')}}/quote" style="background-color: #f4502c !important;border-color: #f4502c !important;">
            Get My Free Quote
          </a>
        </div>
        <!-- Mobile Menu Hamburger-->
        <button class="navbar-toggler btn-close-off-canvas hamburger-icon border-0 collapsed" type="button" data-toggle="collapse" data-target="#mobile-menu" aria-controls="mobile-menu" aria-expanded="false" aria-label="Toggle navigation" style="display:none !important;">
