...
$hourscount = sprintf('%.2f', $hourscount)
?>
                                    ...
                                    <ol start="1" style="margin-left:0px;">
                                        ...
                                        <li style="margin-bottom:18.0pt;" value="1">The Client hereby agrees to engage the Contractor to provide the Client with the following services (the "Services"):
                                            <ul style="margin-left:5.0pt;margin-top:-1.0pt;">
                                                <?php if ($subscriptionx == 'no') { ?>
                                                    <li value="1">{{$skill}} ({{$hourscount}} Rollover Hours)
                                                    </li>
                                                <?php }else { ?>
                                                
                                                    <li value="1">{{$skill}} ({{$hourscount}} Rollover Hours a {{ucwords($interval)}})
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
                                        ...
                                        <li style="margin-bottom:18.0pt;" value="3">The term of this Agreement (the "Term") will begin on {{ \Carbon\Carbon::now()->format('Y-m-d')}} and will remain in full force and effect until subscription cancelation, subject to earlier termination as provided in this Agreement.
                                        </li>
                                        <li class="lh" style="text-align:Left;"><strong><u>Performance</u></strong><strong><u></u></strong>
                                        </li>
                                        <li style="margin-bottom:18.0pt;" value="4"> The Parties agree to do everything necessary to ensure that the terms of this Agreement take effect.
                                        </li>
                                        ...
                                        ?>
                                        <li style="margin-bottom:18.0pt;" value="6">The Contractor will charge the Client for the Services at the rate of {{ currency($amountx, 'USD', currency()->getUserCurrency()) }} per {{$interval}} (the "Compensation") until subscription cancelation or non-payment.
                                            ...
                                            <table class="table table-hover table-bordered table-light text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>{{ $hourscount}} </td>
                                                    <td>{{ \Carbon\Carbon::now()->addYears(1)->format('Y-m-d')}}</td>
                                        ...
                                        <li style="margin-bottom:18.0pt;" value="7">A payment of {{ currency($amountx, 'USD', currency()->getUserCurrency()) }} is payable by the Client upon execution of this Agreement.
                                        </li>
                                        <li style="margin-bottom:18.0pt;" value="8">This is a reoccuring service subscription, the Contractor will invoice or charge the card on file for the Client {{$interval}}ly.
                                        </li>
